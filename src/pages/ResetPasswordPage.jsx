...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="wrap-page pt-0" style={{ position: "relative", overflow: "hidden" }}>
      ...
      <div
        className="w-full min-h-fit flex justify-center px-4"
        style={{ position: "relative", zIndex: 1 }}>
        <div className="glass-box w-full max-w-[500px] shadow-md rounded-xl p-16 sm:p-16">
